...
const HomePage = () => (
    <div className="homepage">
        ...
        <div className="welcome container">
            <h1 className="welcome-title">Bienvenue à l'Association Franco-Vietnamienne de Pneumologie</h1>
