    ...
    return (
      <div className="sign-up col-xl-7 col-lg-8 col-md-10 col-sm-10 col-12 mb-3">
        <ModalPopUp
          ...
          footerClose
        >
          Vous êtes inscrit en tant que donateur. Vous pouvez désormais faire
          des dons dans votre espace personnel !
        </ModalPopUp>
        ...
        <p>
          Veuillez créer un compte pour faire un don à l'association. Nous
          aurons besoin de ces informations pour vous remettre un justificatif
          fiscal.
        </p>
        <p className="sign-up-connect-account">
          Je suis déjà donateur, <a href="/login">je me connecte</a> à mon
          compte.
        </p>
