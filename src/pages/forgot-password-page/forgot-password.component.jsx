...
class ForgotPasswordPage extends React.Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      if (this.props.forgotPasswordError)
        throw new Error(this.props.forgotPasswordError);
      ...
      this.setState({
        ...
        error:
          err.message ||
          "Votre demande de réinitialisation du mot de passe n'a pas été envoyée. Veuillez essayer plus tard.",
      });
    }
  };
  ...
  render() {
    const { email, isModalOpen, error, isLoading, userType, userTypeOptions } =
      this.state;
    return (
      <div className="forgot--password container mt-5 mb-5">
        <ModalPopUp
          ...
          footerClose
        >
          Un lien pour réinitialiser votre mot de passe a été envoyé. Veuillez
        ...
        <div className="forgot--password-frame">
          ...
          <p>
            Veuillez entrez ces informations pour recevoir un lien de
            réinitialisation
          </p>
