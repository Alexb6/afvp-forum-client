...
} from "../../redux/auth/auth-action-functions";
...
class UserPage extends React.Component {
  ...
  userHambugerClick = () => {
    this.setState({ userHambClick: !this.state.userHambClick });
  };
  mobileMenuClose = () => {
    this.setState({ userHambClick: false });
  };
  userProfileClose = () => {
  ...
  renderMenuComponent = () => {
    ...
    if (userProfile && userProfileOpen) {
      return (
        <UserProfile
          userProfile={userProfile}
          userProfileClose={this.userProfileClose}
        />
      );
    }
    if (changePasswordOpen) {
      return (
        <UserPasswordChange changePasswordClose={this.changePasswordClose} />
      );
    } else {
      return (
        <h1 className="welcome">Bienvenue dans votre espace personnel !</h1>
      );
    }
  };
      ...
      <div className="user-page">
        <div className="user-page-titlebar container-fluid mb-3">
          <div className="titlebar-container container">
            ...
            <Hamburger
              toggled={userHambClick}
              toggle={this.userHambugerClick}
              size={36}
              color="#FFFFFF"
            />
          </div>
        ...
        <div className="user--space container">
          <div className="row">
            ...
            <CSSTransition
              in={userHambClick}
              timeout={500}
              classNames="right-side-display-"
            >
              <div
                className="user--display col"
                style={{ minHeight: userMenuHeight + menuAbsoluteOffset }}
              >
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getFreshAccessTokenAsync: (silentAuth) =>
    dispatch(getFreshAccessTokenAsync(silentAuth)),
