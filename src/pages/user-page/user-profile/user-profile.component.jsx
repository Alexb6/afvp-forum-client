...
class UserProfile extends React.Component {
  ...
  renderArrayProfile = () => {
    ...
    ArrayProfile.push(
      <div
        className="profile--group profile--photo-name"
        key="profile--photo-name"
      >
          ...
          {nameFormOpen ? (
            <form autoComplete="off">
              ...
              <FormCancelValidButtons
                closeForm={this.handleNameFormClose}
                closeText="Annuler"
                submitText="Modifier"
                submitForm={this.handleNameFormSubmit}
              />
            </form>
          ) : (
            <>
    ...
    ArrayProfile.push(
      <div
        className="profile--group profile--specialty-title"
        key="profile--specialty-title"
      >
        {specialityFormOpen ? (
          <form autoComplete="off">
            <FormInput
            ...
            <FormCancelValidButtons
              closeForm={this.handleSpecialityFormClose}
              closeText="Annuler"
              submitText="Modifier"
              submitForm={this.handleSpecialityFormSubmit}
            />
          </form>
        ) : (
          <>
    ...
    ArrayProfile.push(
      <div
        className="profile--group profile--email-address"
        key="profile--email-address"
      >
        {emailFormOpen ? (
          <form autoComplete="off">
            <FormInput
            ...
            <FormCancelValidButtons
              closeForm={this.handleEmailFormClose}
              closeText="Annuler"
              submitText="Modifier"
              submitForm={this.handleEmailFormSubmit}
            />
          </form>
        ) : (
          <>
    ...
    ArrayProfile.push(
      <div
        className="profile--group profile--biography-hobby"
        key="profile--biography-hobby"
      >
        {bioFormOpen ? (
          <form autoComplete="off">
            <FormTextArea
            ...
            <FormCancelValidButtons
              closeForm={this.handleBioFormClose}
              closeText="Annuler"
              submitText="Modifier"
              submitForm={this.handleBioFormSubmit}
            />
          </form>
        ) : (
          <>
...
const mapDispatchToProps = (dispatch) => ({
  updateUserProfileAsync: (userData) =>
