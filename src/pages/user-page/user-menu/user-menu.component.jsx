...
const UserMenu = ({
  ...
  <div className="user-aside-menu col">
      ...
      <div className="user--infos">
        <div className="user--photo--name">
          <div className="user--photo">
            {currentUser.photo_url ? (
              <div className="photo--link">
                <img
                  className="link"
                  src={`${process.env.REACT_APP_SERVER_ORIGIN}/${currentUser.photo_url}`}
                  alt={`${currentUser.first_name} ${currentUser.family_name}`}
                />
              </div>
            ) : (
          ...
          <div className="user--name">
            {currentUser.first_name} {currentUser.family_name}
          </div>
        </div>
    ...
    <CustomSmallButton
      ...
      type="submit"
      className="custom-small-button--positive--duck-light mb-2"
    >
      Déconnexion
    </CustomSmallButton>
