  ...
  handleSubmit = async (e) => {
    ...
    if (formIsValid(this.state.formErrors)) {
      ...
      try {
        ...
        if (this.props.updateMyPasswordError)
          throw new Error(this.props.updateMyPasswordError);
        ...
        this.setState({
          isLoading: false,
          error:
            this.props.updateMyPasswordError ||
    ...
    return (
      <>
        ...
        <form className="user--password--change" autoComplete="off">
          ...
          <div className="password--change--introduction">
          ...
          <FormInput
            ...
            required
          />
          {formErrors.password_current.length > 0 &&
            password_current.length > 3 && (
              <FormErrorMessage>{formErrors.password_current}</FormErrorMessage>
            )}
          <FormInput
            type="password"
            name="password"
...
const mapDispatchToProps = (dispatch) => ({
  updateMyPasswordAsync: (userData) =>
    dispatch(updateMyPasswordAsync(userData)),
});
