      ...
      try {
        ...
        if (
          ...
          this.setState({
            ...
            error:
              err.message ||
              "Votre demande de connexion n'a pas été envoyée. Veuillez essayer plus tard.",
          });
        }
      }
    }
    ...
    return (
      <div className="sign-in col-md-6 col-sm-12 mb-3">
        ...
        <p className="sign-in-create-account">
          Je ne suis pas encore donateur, je{" "}
          <a href="/sign-up-donor">crée un compte</a> pour soutenir
          l'association.
        </p>
